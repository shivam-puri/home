                ...
                <div className="experience">
                    <div className="experience_info">
                        ...
                        <div className="experience_des">
                            participated in a 48 hour long hackathon and demonstrated exceptional technical expertise, innovation and problem-solving abilities.
                        </div>
                    </div>
                </div>
